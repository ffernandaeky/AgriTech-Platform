  ...
  return (
    <div className="relative z-1 flex min-h-screen flex-col items-center justify-center overflow-hidden p-6">
      ...
      <div className="mx-auto w-full max-w-[472px] text-center">
        <p className="mb-4 text-[11px] font-black uppercase tracking-[0.3em] text-[#15803d] dark:text-green-400">
          Agri-Tech
        </p>
        ...
        <p className="mb-6 mt-10 text-base text-gray-700 dark:text-gray-400 sm:text-lg">
          Halaman yang Anda cari tidak tersedia di Agri-Tech.
        </p>
      ...
      <p className="absolute bottom-6 left-1/2 -translate-x-1/2 text-center text-sm text-gray-500 dark:text-gray-400">
        &copy; {new Date().getFullYear()} - Agri-Tech
      </p>
    </div>
  );
}

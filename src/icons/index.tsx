...
export {
  ...
  // SOLUSI: Menggunakan file yang sudah ada agar tidak error
  ListIcon as GlobeIcon,   // Menggunakan ListIcon untuk mewakili Web
  DocsIcon as SearchIcon, // Menggunakan DocsIcon untuk mewakili Keyword
  BoltIcon as CpuIcon
};
